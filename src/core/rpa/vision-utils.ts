...
- 左侧第二列是聊天联系人列表，头像右上角有红色未读气泡的表示该联系人有未读消息

## 你的职责
帮我框选以下两个区域，每个区域用 <bbox>x1,y1,x2,y2</bbox> 格式，坐标范围 0-1000：
1. 【聊天入口按钮区域】— 导航栏中的聊天按钮，包含图标和红色角标
2. 【第一个有未读红点的联系人】— 在左侧联系人列表中，从头开始往下找，找到第一个头像右上角有红色未读气泡的联系人，框选该联系人头像区域（包含头像和红色气泡）

注意：第2点必须选有红色未读气泡的联系人，如果没有找到，只返回第1个bbox`,
