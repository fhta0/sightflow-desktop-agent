...
- **中间列**：聊天联系人列表
  - 顶部是搜索框和加号按钮
  - 下方是联系人列表，每个联系人项包含：头像（圆形）、名称、最新消息预览
  - 头像右上角有红色圆形数字角标（如"1","2","5","10","50","99+"）表示该联系人有未读消息
- **右侧**：聊天区域（当前对话内容）
...
2. 【第一个有未读红点的联系人】— 在**中间列**的联系人列表中：
   - 从上往下找（从搜索框下面开始）
   - 找到第一个**头像右上角有红色数字角标**的联系人
   - 框选该联系人的**头像区域**（圆形头像，包含红色数字角标）
   - 如果没有找到带红点的联系人，只返回第1个bbox

重要提示：
- 第2个bbox必须在**中间列**（联系人列表），不是在左侧导航栏，也不是在右侧聊天区
- 要确认看到红色数字角标（如"1","2"等），不只是绿色背景`,
